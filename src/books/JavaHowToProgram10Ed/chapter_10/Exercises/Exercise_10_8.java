...
public class Exercise_10_8 {
    ...
    // ANS: I'll use an abstract class if I have to provide functionalities for related
    //      subclasses, I'll use interfaces, if the classes implementing the interface
    //      aren't related.
}
